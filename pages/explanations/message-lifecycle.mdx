...
In this process, the dApp developer handles [initiating the cross-chain call](/quickstart/sending-a-message-with-xcall), [responding to events](/guides/receiving-a-message), and [errors](/guides/error-handling).
