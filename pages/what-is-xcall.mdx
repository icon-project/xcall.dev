...
## A cross-chain messaging interface deployable on any protocol
...
Currently, xCall supports the [Blockchain Transmission Protocol (BTP)](https://docs.icon.community/cross-chain-communication/blockchain-transmission-protocol-btp) and (IBC)[https://ibc.cosmos.network/main]. The IBC integration connects through smart contracts and its implementation details can be found (here)[https://github.com/icon-project/IBC-Integration]. Chains supported by BTP are ICON, Havah, Ethereum, and Binance Smart Chain. Chains supported by IBC are ICON and Archway.
...
Here's the [Getting Started](/getting-started) guide that will kickstart your journey building with xCall. 
