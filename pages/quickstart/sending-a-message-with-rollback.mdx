...
For the case of showcasing sending a message with rollback please follow the prerequisites and instructions on the [previous tutorial](sending-a-message.md).
...
A code example of how to wait for these events on an ICON chain can be seen in the [DAppProxySampleUtilityFunctions repo](https://github.com/icon-community/DAppProxySampleUtilityFunctions) used for this tutorial.
