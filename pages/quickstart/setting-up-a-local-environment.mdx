---
description: This is how to setup a local environment to test the xCall functionality.
---
...
<Callout type="info" emoji="💡">
  The first iteration of xCall on ICON mainnet will use the Blockchain Transmission Protocol to provide interoperability functionality
</Callout>
