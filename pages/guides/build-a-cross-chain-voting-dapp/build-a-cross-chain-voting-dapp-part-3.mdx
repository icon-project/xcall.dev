---
title: "Integrating rollback functionality in the cross chain voting dApp (3/4)"
date: 2023-07-25
author: espanicon
...
The logic executes the same as the example showcase in [part 2 of this xCall tutorial series](build-a-cross-chain-voting-dapp-part-2.md) but we modify the script to continually keep casting votes until the votes cap is reached and then we execute one more vote to trigger the rollback.
